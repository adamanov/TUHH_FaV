...
(cl:in-package controller_main-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <newMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'newMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller_main-msg:<newMsg> is deprecated: use controller_main-msg:newMsg instead.")))
