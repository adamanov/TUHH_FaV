...
(cl:in-package depth_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ActuatorCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActuatorCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name depth_controller-msg:<ActuatorCommands> is deprecated: use depth_controller-msg:ActuatorCommands instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:header-val is deprecated.  Use depth_controller-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:roll-val is deprecated.  Use depth_controller-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:pitch-val is deprecated.  Use depth_controller-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:yaw-val is deprecated.  Use depth_controller-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'thrust-val :lambda-list '(m))
(cl:defmethod thrust-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:thrust-val is deprecated.  Use depth_controller-msg:thrust instead.")
  (thrust m))

(cl:ensure-generic-function 'lateral_thrust-val :lambda-list '(m))
(cl:defmethod lateral_thrust-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:lateral_thrust-val is deprecated.  Use depth_controller-msg:lateral_thrust instead.")
  (lateral_thrust m))

(cl:ensure-generic-function 'vertical_thrust-val :lambda-list '(m))
(cl:defmethod vertical_thrust-val ((m <ActuatorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader depth_controller-msg:vertical_thrust-val is deprecated.  Use depth_controller-msg:vertical_thrust instead.")
  (vertical_thrust m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ActuatorCommands>)))
  ...
  "depth_controller/ActuatorCommands")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ActuatorCommands)))
  "Returns string type for a message object of type 'ActuatorCommands"
  "depth_controller/ActuatorCommands")
