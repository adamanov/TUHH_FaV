...
class ExtendedKalmanFilter():
    def __init__(self, name):
       ...
       # rospy.set_param('tag1',[0.5, 3.35,-0.5])
        ...
        rospy.set_param('std_tag1', 4) # from measurement
        rospy.set_param('std_tag2', 4)
        rospy.set_param('std_tag3', 4)
        rospy.set_param('std_tag4', 4)
    ...
    def mapping_state_to_range(self):
        ...
        print('ranges: ',ranges,np.size(ranges))
        return ranges
    ...
    def get_jacobi_matrix(self):
        ...
        for i in range(4):
            ...
            jacobi_matrix[i,0:3] = np.transpose(self.state_vector[0:3]) / np.linalg.norm(self.tags[i] - self.state_vector[0:3])
    ...
    def publish_states(self):
        ...
        print(np.size(self.state_vector))
