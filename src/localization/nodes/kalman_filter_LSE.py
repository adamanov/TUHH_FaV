...
class KalmanFilter():
    ...
    def position_callback(self, msg):
        ...
        R = np.diag([rospy.get_param('std_x'), rospy.get_param(
            'std_y'), rospy.get_param('std_z')])
    ...
    def imu_callback(self, msg):
        ...
        # print("y: " + str(y))
        R = np.diag([rospy.get_param('std_v_x'), rospy.get_param(
            'std_v_y'), rospy.get_param('std_v_z')])
        # print("R: " + str(R))
